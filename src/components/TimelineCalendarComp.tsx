...
export default class TimelineCalendarComp extends Component {
  state = {
    currentDate: getDate(),
    events: EVENTS,
  ...
  onDateChanged = (date: string, source: string) => {
    console.log('TimelineCalendarComp onDateChanged: ', date, source);
    this.setState({currentDate: date});
  };

  onMonthChange = (month: any, updateSource: any) => {
    console.log('TimelineCalendarComp onMonthChange: ', month, updateSource);
  };
